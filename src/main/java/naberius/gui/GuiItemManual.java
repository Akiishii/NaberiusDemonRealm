...
public class GuiItemManual extends GuiScreen{
    ...
    private static final ResourceLocation manualMainText = new ResourceLocation(NaberiusCore.ModID, "text/manual.txt");
    private static final ResourceLocation manualDimensionText = new ResourceLocation(NaberiusCore.ModID, "text/manual_dimension.txt");
    private static final ResourceLocation iconGuiElements = new ResourceLocation(NaberiusCore.ModID, "textures/gui/guielements.png");

    public GuiItemManual(int manual) {
    ...
    public void initGui() {
        ...
        textPage = new TextPage(NaberiusCore.INSTANCE, mc, this).setText(manualText).setArrowImage(iconGuiElements, 144, 0).setCraftingGridImage(iconGuiElements, 0, 192);

        prevButton = new Button(mc, this).setText("<").addButtonEvent(new ButtonEvent() {
            @Override
            public void buttonClicked(Widget parent) {
                System.out.println("GuiManual.buttonClicked: <");
                textPage.prevPage();
