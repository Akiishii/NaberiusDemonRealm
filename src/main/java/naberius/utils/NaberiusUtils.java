...
public class NaberiusUtils {
	...
	public static BlockPos[] getBreakArea(ItemToolAoE hammerItem, BlockPos pos, EnumFacing sideHit, EntityPlayer player)
    {
    ...
    private static boolean breakBlockChecks(ItemStack stack, World world, BlockPos blockPos, IBlockState block)
    {
        ...
        if(!((ItemToolAoE)stack.getItem()).isEffective(block)) return false;
