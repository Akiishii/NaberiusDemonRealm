...
public class TileHellForge extends TileEntity implements ITickable, ISidedInventory {
	...
	public int getCookTime() {
		...
		HellForgeRecipe recipe = HellForgeRecipe.getMatchingRecipe(getInputStacks());
		if (recipe != null) {
	...
	public void smeltItem() {
		...
		if (canSmelt()) {
			...
			// Consume ingredients
			HellForgeRecipe recipe = HellForgeRecipe.getMatchingRecipe(getInputStacks());
			HellForgeRecipeObject[] inputList = recipe.getInputs();
			for (HellForgeRecipeObject recipeObject : inputList) {
	...
	/*
	  ...
	  public boolean isItemValidForSlot(int index, ItemStack stack) {
	    ...
	    if (index == SLOT_FUEL) {
	      ...
	      return HellForgeRecipe.isValidIngredient(stack);
	    }
	  ...
	  public Container createContainer(InventoryPlayer playerInventory, EntityPlayer player) {
	    ...
	    return new ContainerHellForge(playerInventory, this);
